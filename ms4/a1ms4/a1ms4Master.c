...
void populateAccounts(struct Account accounts[], int arrSize)
{
    ...
    struct Account tmp[INIT_DATA_SIZE] = {
        { 50001, ACCT_CUSTOMER, {"Silly Sally", 1990, 150000.10, "CANADA"}, {"", ""}  },
        { 50028, ACCT_AGENT,    {"Fred Flintstone", 1972, 2250400.22, "AFRICA"}, {"Bedrock-10", "yabadaba"} },
        { 50004, ACCT_CUSTOMER, {"Betty Boop", 1978, 250800.74, "INDIA"}, {"", ""}},
        { 50008, ACCT_AGENT,    {"Will Smith", 1952, 2350600.82, "U.S.A."}, {"MIBAgent-J", "theboss1"} },
        { 50020, ACCT_CUSTOMER, {"Shrimpy Shrimp", 2000, 350500.35, "KOREA"}, {"", ""} }
    };
